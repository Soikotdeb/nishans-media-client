...
const Mission = () => {
    return (
        <div className="bg-black text-white">
            <div className="grid grid-cols-3 gap-5 items-center justify-center p-5 md:p-20">
                <div className="p-5 md:p-10 text-center md:text-start  flex gap-1">
                    <AiFillPieChart className='text-white text-3xl w-4/12' />
                    <div>
                ...
                <div className="p-5 md:p-10 text-center md:text-start flex gap-1">
                    <BiPaperPlane className='text-white text-3xl w-4/12' />
                    <div>
                ...
                <div className="p-5 md:p-10 text-center md:text-start flex">
                    <FaCertificate className='text-white text-3xl w-4/12' />
                    <div>
